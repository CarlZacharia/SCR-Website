<?php
    ...
    $a1name = (string) $_POST['a1namem'];
    $a2name = (string) $_POST['a2namem'];
    ...
    $fn = 'Will-'.$wife.'.docx';
    $s = "docs_archive/PA-Will-Female-Single.docx";
    $wordDoc = 'Will-'.$wife.'.docx';
    copy($s, $wordDoc);
    ...
    if ($zip->open($wordDoc) === TRUE) {
        ...
        $newft = str_replace('wifey', $wife, $oldft);      
        $zip->deleteName($ft);
